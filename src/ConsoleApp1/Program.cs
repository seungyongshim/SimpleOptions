...
builder.Services.AddSimpleOptions<SimpleImmutableOption>("microservice1");
builder.Services.AddSimpleOptions<SimpleImmutableOption>("microservice1:ExternalService1");
